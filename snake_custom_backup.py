...
class Snake:
    ...
    def move(self):
        ...
        world[self.pos[-1][0][0] // tilesize][self.pos[-1][0][1] // tilesize] = 0
    ...
    def look(self):
        ...
        # Check south
        s_d_t_w = height - h_c[1]
        for i, row in enumerate(reversed(world)):
            if row[h_c[0]] == 2:  # Check the tile on the row that aligns with the heads x coordinate
                s_d_t_f = i+1
        ...
        for i, tile in enumerate(world[h_c[1]][h_c[0]:]):
        ...
        # Northeast
        # r is the distance to the edge northeast, this ttok a while to get right
        r = -1
        if c_x == c_y:
            r = width - c_x
        elif c_x < c_y:
    ...
    def update_world_coords(self):
        ...
        for p in self.pos:
            world[p[0][0] // tilesize][p[0][1] // tilesize] = 1
...
class Fruit:
    def __init__(self, avoid_snake: Snake):
        ...
        world[spawn_pos[0] // tilesize][spawn_pos[1] // tilesize] = 2
...
class SnakeGame:
    ...
    def step(self, direction):
        ...
        if collided == 1 or self.steps_left == 0:
            ...
            world[self.fruit.corner_pos[0] // tilesize][self.fruit.corner_pos[1] // tilesize] = 1
