...
class SnakeBrain:
    ...
    def play(self, graphical=False, delay: float=0., fruits=1):
        """
        ...
        self.game = snake_custom_2.SnakeGame(graphical, fruits)
